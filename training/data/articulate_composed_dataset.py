...
class ArticulateComposedDataset(Dataset, ABC):
    ...
    def __init__(self, dataset_configs: dict, common_config: dict, **kwargs):
        ...
        for baseset_dict in dataset_configs: # [2026-02-10] @tcm: here len(dataset_configs) = 1, and baseset_dict is dataset_configs in the default_pm.yaml file
            baseset = instantiate(baseset_dict, common_conf=common_config) # [2026-02-10] @tcm: common_config is common_config in default_pm.yaml file (here, under data/train/); baseset: data.datasets.co3d.Co3dDataset
        ...
        self.total_samples = len(self.base_dataset) # [2026-02-10] @tcm: 10000
...
class TupleConcatDataset(ConcatDataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.inside_random:
            total_len = self.cumulative_sizes[-1] # [2026-02-10] @tcm: self.cumulative_sizes = [100000]
